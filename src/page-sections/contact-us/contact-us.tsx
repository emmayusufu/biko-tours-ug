          ...
          <div>
            ...
            <div className="flex flex-col mb-4">
              <div className="text-justify text-sm lg:text-sm">
                Need help from a technical person, send us a message via the
                form , we’ll get back to you with 30 minutes. Give as much
                detail as possible to get immediate attention.
              </div>
            </div>
